...
--
-- Host: localhost
-- Generation Time: Apr 10, 2017 at 10:48 AM
...
CREATE TABLE IF NOT EXISTS `diary` (
  ...
  KEY `fk_diary_member_no` (`member_no`),
  KEY `fk_diary_att_no` (`att_no`)
...
CREATE TABLE IF NOT EXISTS `unattractions` (
  ...
  `last_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`un_id`),
  KEY `fk_unatt_member_no` (`member_no`),
  KEY `fk_unatt_att_no` (`att_no`)
