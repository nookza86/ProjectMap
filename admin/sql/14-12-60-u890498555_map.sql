...
--
-- Host: localhost:3306
-- Generation Time: Dec 14, 2017 at 02:55 AM
...
(1, 'Bang Pae Waterfall', 'There is a relatively small waterfall and cool refuge with various species of tree. The waterfall is also home to Gibbon Rehabilitation Center. There is smaller than Ton Sai Waterfall and has a lot of rock which beside brook. There are troughs for bathing. It pours a great volume of water in all season.', 'uploads/attractions/Bang Pae Waterfall/1.jpg', '2017-04-14 01:06:54'),
(2, 'Big Buddha', 'Phuket is Big Buddha is one of the island is most important and revered landmarks on the island. The huge image sits on top of the Nakkerd Hills between Chalong and Kata and, at 45 metres tall, it is easily seen from far away. The lofty site offers the best 360-degree views of the island.', 'uploads/attractions/Big Buddha/1.jpg', '2017-04-13 16:48:29'),
(3, 'Chalong Temple', 'Chalong Temple, It is a religious place in Phuket. A temple with a long history and the most beautiful in Phuket. This temple is famous for its sacred Luang Por Cham. The reputation of Luang Por Cham further to neighboring countries like Penang Malaysia.', 'uploads/attractions/Chalong Temple/1.jpg', '2017-04-09 18:37:53'),
(4, 'Kamala Beach', 'Kamala Beach is very quiet and located in the South of Surin Beach. Grain of sand is not fine. The beach is approximately 2 km longs. There is a tsunami monument that is a reminder of the tsunami and the terrible damage it inflicted.', 'uploads/attractions/Kamala Beach/1.jpg', '2017-04-09 18:37:53'),
(5, 'Karon Beach', 'Karon Beach is one of Phuket’s longest beaches and located near The North of Kata Beach. Karon Beach is split from Kata Beach by a small hill. Larch trees and sugar palm trees fringe the beach. There are strong wave and wind, therefore this is not a favorite tourist beach for bathing but suitable for sunbathing and strolling. ', 'uploads/attractions/Karon Beach/1.jpg', '2017-04-09 18:37:53'),
(6, 'Kata Beach', 'Kata Beach is located between Kata Noi and Karon Beaches. Kata beach is a popular beach on Phuket Island. The beach has soft white sand and palm trees fringe. Large number of tourists choose to stay in Kata beach as it is quite and more peaceful than the other beaches.', 'uploads/attractions/Kata Beach/1.jpg', '2017-04-09 18:37:53'),
(7, 'Patong Beach', 'Patong Beach is the most popular tourists place in Phuket Island. Patong beach is an absolutely perfect bathing beach with fine white sand. There also have a lot of water activities such as Jet Ski, speed boat, parasailing, banana boat, windsurfing, wakeboard. Patong Beach is a heaven for most tourists.', 'uploads/attractions/Patong Beach/1.jpg', '2017-04-09 18:37:53');
...
(13, 1, 3, 'I', 4, 4, 4, '3_1_1.jpg', '3_1_2.jpg', '3_1_3.jpg', '3_1_4.jpg', '2017-12-10 15:53:27');
...
(1, 'Krittanan', 'Hokhuadsim', 'nook_we@hotmail.com', 'gkwS23mrXwl3H/aXEp79jg3ut7o0ZmUxOTUwZTNk', '4fe1950e3d', 'Male', '1996-01-07', 'Australia', '0', '59190c173ec008.39005804', 'Yes', '1.jpg', '2017-12-10 01:34:06'),
...
(23, 1, 3, 7.89378, 98.3548, '2017-12-10 15:44:27');
...
--
ALTER TABLE `diary`
  MODIFY `diary_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `members`
--
ALTER TABLE `members`
  MODIFY `member_no` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `unattractions`
--
ALTER TABLE `unattractions`
  MODIFY `un_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;COMMIT;
