...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-9" name="maincontent" id="maincontent">
		...
		<div class="panel-heading"><h5>Delete Unlock attractions</h5></div>
			...
			$query="DELETE FROM unattractions WHERE un_id = '$un_id' ";
			...
			if($qr==false){
				...
				echo"<div class='alert'><center>Delete successfully<br/>Back to Unlock attractions in 2 sec.</center><br />";
