...
include ("$root/admin/inc/smart_resize_image.function.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php
	...
	if(isset($_POST["att_name"]) && isset($_POST["descriptions"]) && $uploadCheck == 1){
			...
			$query="INSERT INTO attractions (`att_name`, `descriptions`, `att_img`, `last_update`) VALUES ('$att_name','$descriptions','$att_img',NOW());
			  ";
			...
			if($qr==false){
				...
				$file = $att_img;
				$resizedFile = $att_img;
				smart_resize_image($file , null, 256 , 0 , true , $resizedFile , false , false ,100 );
